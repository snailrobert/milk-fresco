...
public class ShenAdapter extends BaseAdapter<ShenViewHolder, ShenBean> {
    ...
    public ShenViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ShenViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.item_description, parent, false));
    }

    @Override
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ((ShenViewHolder) holder).bindView(mBeans.get(position));
    }
}
