...
public class GkdGifViewHolder extends BaseViewHolder<GkdGifBean> {
    ...
    public GkdGifViewHolder(View itemView) {
        super(itemView);
    }

    @Override
    public void bindView(final GkdGifBean bean) {
        ...
        mCardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ((BaseActivity) mContext).addFragment(GifFragment.newInstance(bean.getUrl()));
            }
        });
