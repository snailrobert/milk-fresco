...
public class ItMtuViewHolder extends BaseViewHolder<ItMtuBean> {
    ...
    public ItMtuViewHolder(View itemView) {
        super(itemView);
    }

    @Override
    public void bindView(final ItMtuBean bean) {
        ...
        mCardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ((BaseActivity) mContext).addFragment(MtuFragment.newInstance(bean.getUrl()));
            }
        });
