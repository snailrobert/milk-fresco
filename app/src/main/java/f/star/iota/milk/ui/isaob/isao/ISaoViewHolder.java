...
public class ISaoViewHolder extends BaseViewHolder<ISaoBean> {
    ...
    public ISaoViewHolder(View itemView) {
        super(itemView);
    }

    @Override
    public void bindView(final ISaoBean bean) {
        ...
        mCardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ((BaseActivity) mContext).addFragment(BFragment.newInstance(bean.getUrl()));
            }
        });
