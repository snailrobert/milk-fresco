...
import f.star.iota.milk.ui.yeitu.tu.TuFragment;


public class YeiTuViewHolder extends BaseViewHolder<YeiTuBean> {
    ...
    public YeiTuViewHolder(View itemView) {
        super(itemView);
    }

    @Override
    public void bindView(final YeiTuBean bean) {
