...
import f.star.iota.milk.ui.www52guzhuang.www.WWWFragment;


public class GuZhuangViewHolder extends BaseViewHolder<GuZhuangBean> {
    ...
    public GuZhuangViewHolder(View itemView) {
        super(itemView);
    }

    @Override
    public void bindView(final GuZhuangBean bean) {
        ...
        mCardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ((BaseActivity) mContext).addFragment(WWWFragment.newInstance(bean.getUrl()));
            }
        });
