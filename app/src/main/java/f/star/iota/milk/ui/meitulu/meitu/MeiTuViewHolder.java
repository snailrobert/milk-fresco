...
import f.star.iota.milk.ui.meitulu.lu.LuFragment;


public class MeiTuViewHolder extends BaseViewHolder<MeiTuBean> {
    ...
    @Override
    public void bindView(final MeiTuBean bean) {
        ...
        mCardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ((BaseActivity) mContext).addFragment(LuFragment.newInstance(bean.getUrl()));
            }
        });
