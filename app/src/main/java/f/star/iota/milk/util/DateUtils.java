...
public class DateUtils {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println(DateUtils.dateFormat(DateUtils.dateAddDays(DateUtils.dateParse("20190911",DateUtils.DATE_PATTERN_YYYYMMDD),-1),DateUtils.DATE_PATTERN_YYYYMMDD));
    }
}
