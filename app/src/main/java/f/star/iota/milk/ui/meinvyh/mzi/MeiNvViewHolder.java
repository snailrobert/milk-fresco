...
import f.star.iota.milk.ui.meinvyh.yh.YHFragment;


public class MeiNvViewHolder extends BaseViewHolder<MeiNvBean> {
    ...
    @Override
    public void bindView(final MeiNvBean bean) {
        ...
        mCardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ((BaseActivity) mContext).addFragment(YHFragment.newInstance(bean.getUrl()));
            }
        });
