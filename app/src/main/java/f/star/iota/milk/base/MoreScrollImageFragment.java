...
public abstract class MoreScrollImageFragment<P extends PVContract.Presenter, A extends BaseAdapter> extends BaseFragment implements PVContract.View {
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        ...
        if (isVisibleToUser == false && mAdapter != null && mAdapter.getItemCount() != 0) {
            mAdapter.clear();
