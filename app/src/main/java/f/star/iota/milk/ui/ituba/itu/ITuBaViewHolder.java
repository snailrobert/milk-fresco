...
import f.star.iota.milk.ui.ituba.ba.BaFragment;


public class ITuBaViewHolder extends BaseViewHolder<ITuBaBean> {
    ...
    public ITuBaViewHolder(View itemView) {
        super(itemView);
    }

    @Override
    public void bindView(final ITuBaBean bean) {
