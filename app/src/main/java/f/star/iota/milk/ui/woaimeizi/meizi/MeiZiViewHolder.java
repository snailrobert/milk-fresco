...
public class MeiZiViewHolder extends BaseViewHolder<MeiZiBean> {
    ...
    @Override
    protected List<PCBean> getProcessingCompletedBeans(List<MeiZiBean> beans) {
        List<PCBean> imgs = new ArrayList<>();
        for (MeiZiBean bean : beans) {
            imgs.add(new PCBean(bean.getUrl(), bean.getUrl(), Menus.MENU_WOAIMEIZI,
