...
import f.star.iota.milk.ui.girlsky.sky.SkyFragment;


public class GirlSkyViewHolder extends BaseViewHolder<GirlSkyBean> {
    ...
    public GirlSkyViewHolder(View itemView) {
        super(itemView);
    }

    @Override
    public void bindView(final GirlSkyBean bean) {
        ...
        mCardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ((BaseActivity) mContext).addFragment(SkyFragment.newInstance(bean.getUrl()));
            }
        });
