...
import f.star.iota.milk.ui.mmcools.mm.MmFragment;


public class MMCOOLSViewHolder extends BaseViewHolder<MMCOOLSZiBean> {
    ...
    public MMCOOLSViewHolder(View itemView) {
        super(itemView);
    }

    @Override
    public void bindView(final MMCOOLSZiBean bean) {
        ...
        mCardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ((BaseActivity) mContext).addFragment(MmFragment.newInstance(bean.getUrl()));
            }
        });
